...
Version 2 marked a significant evolution, introducing password analysis through a set of conditional statements and a vault, fortified with SHA-256 bit hash<a href = "https://en.wikipedia.org/wiki/Secure_Hash_Algorithms"><sup>1</sup></a> and HMAC<a href = "https://en.wikipedia.org/wiki/HMAC"><sup>2</sup></a>. Notably, salting was added to enhance security. Subsequent versions led to the current version, version - 7, the pinnacle of Cipher, offering the most refined and secure features to date.
...
The neural network was trained on a custom dataset curated by us, which categorized password strength into three labels: weak, medium, and strong. The dataset encompasses passwords from various sources, including infamous leaked <a href = "https://en.wikipedia.org/wiki/RockYou#Data_breach" >RockYou</a> passwords and other leaked passwords found on the internet, these passwords were then scraped using <a href = "https://www.crummy.com/software/BeautifulSoup/" >BeautifulSoup</a>. Additionally, passwords generated using Cipher and the QRNG were included.
...
<ul>
<li>Email: <a href = "mailto:ranveerchaudhary1000+github@gmail.com">ranveerchaudhary1000+github@gmail.com</a></li>
